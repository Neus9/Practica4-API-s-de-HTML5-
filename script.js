  ...
  function handleFileSelect(evt) {
      ...
      reader.onload = (function (theFile) {
          return function (e) {
              ...
              let volumeUp = document.getElementById('subir');
              let volumeDown = document.getElementById('bajar');
              
              playButton.addEventListener('click', () => {document.getElementById('video').play();});
              
              pauseButton.addEventListener('click', () => {document.getElementById('video').pause();})

              volumeUp.addEventListener('click', () => {document.getElementById('video').volume += 0.1;})

              volumeDown.addEventListener('click', () => {document.getElementById('video').volume -= 0.1;})
